...
- Create Angular project with ng: `ng new hotelmanagementsystem.client --defaults --skip-install --skip-git --no-standalone `.
...
- Update `app.config.ts` to import the HttpClientModule.
- Create project file (`hotelmanagementsystem.client.esproj`).
